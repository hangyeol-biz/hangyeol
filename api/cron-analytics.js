...
const LEADS_TABLE_ID = 'tblv1hdnYYIeU1V5h'; // 게시판 테이블 ID (한결)
const GA4_PROPERTY_ID = getEnv('GA4_PROPERTY_ID', '520547177');
const SEARCH_CONSOLE_SITE = getEnv('SEARCH_CONSOLE_SITE', 'https://biz-hangyeol.co.kr');
